...
const AuthenticatedApp = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/Discover" element={<LayoutWrapper currentPageName="Feed"><MainPage /></LayoutWrapper>} />
      ...
      <Route path="/Demos" element={<LayoutWrapper currentPageName="Demos"><Demos /></LayoutWrapper>} />
