...
export function FAQ() {
  const faqs = [
    { q: "What is Collab Unity?", a: "A project-first platform where creators, learners, and innovators build together. Every project gets a free-form canvas workspace with real-time collaboration, a built-in AI assistant, and everything you need to plan, build, and ship — all in one place." },
    { q: "Is it free?", a: "Yes. Core features are free forever — create projects, run the canvas workspace, message teammates, use the Project Assistant, and build your profile at no cost." },
    { q: "Who is it for?", a: "Students, developers, designers, founders, and hobbyists — anyone who wants to build something with other people." },
    { q: "What is the project canvas?", a: "Collab Unity's signature workspace: a free-form, drag-and-drop canvas where every part of your project lives together — tasks, milestones, assets, ideation notes, showcase links, funding, analytics, highlights, and a Project Assistant. Move, toggle, and arrange everything your way." },
    { q: "Can I collaborate in real time?", a: "Yes. Collaborators see each other's presence and cursors on the canvas as you work, so it feels like building together in the same room." },
    { q: "What is the Project Assistant?", a: "An AI assistant built into each project that can generate tasks and milestones, draft ideation content, suggest tools, and help move your project forward — right from the canvas." },
