...
export default function ProjectMentionCard({ projectId, isOwn }) {
  ...
  return (
    <div
      className="mt-2 rounded-xl border border-purple-200 bg-white overflow-hidden min-w-[240px] max-w-[300px] cursor-pointer hover:border-purple-400 hover:shadow-md transition-all"
