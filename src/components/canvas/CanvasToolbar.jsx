...
import {
  ZoomIn, ZoomOut, Maximize, Plus, LayoutGrid,
} from "lucide-react";

export default function CanvasToolbar({
  zoom, onZoomIn, onZoomOut, onZoomFit, onOrganize,
        ...
        {!readOnly && (
          <>
            <button
              ...
              className={`p-1.5 md:p-2 rounded-full ${addOpen ? "bg-[#18A0FB] text-white" : "text-gray-600 hover:bg-gray-100"}`}
              title="Add component"
            >
