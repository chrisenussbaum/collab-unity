...
// Height is constrained to the viewport with the action pinned at the bottom
// so the card is always fully visible without page scrolling.
export default function ReadOnlyProjectBanner({ project, projectUsers, projectOwnerProfile, canApply, onApply }) {
  ...
  return (
    <div className="absolute top-3 left-3 z-30 w-[300px] max-w-[calc(100vw-24px)] max-h-[calc(100%-16px)] flex flex-col bg-white/95 backdrop-blur rounded-xl border border-gray-200 shadow-lg overflow-hidden">
      <div className="flex items-center justify-between px-3 py-2 bg-gradient-to-r from-purple-50 to-indigo-50 border-b border-gray-100 flex-shrink-0">
      ...
      <div className="flex-1 overflow-y-auto p-3 min-h-0">
        ...
        <p className="text-xs text-gray-600 leading-relaxed line-clamp-4 mb-2">{project?.description}</p>
      ...
      <div className="flex-shrink-0 p-3 pt-2 border-t border-gray-100 bg-white">
        {canApply && (
