                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <h3 className="font-bold text-lg text-gray-900 mb-1">You've Been Invited!</h3>
                      <p className="text-sm text-gray-700">
                        You've been invited to join this project as a collaborator.
                        {pendingInvitation.message && (
                          <span className="block mt-2 italic text-gray-600">"{pendingInvitation.message}"</span>
                        )}
                      </p>
                    </div>
                  </div>
                  <div className="flex space-x-3 sm:flex-shrink-0">
                    <Button onClick={handleAcceptInvitation} disabled={isRespondingToInvite} className="cu-button flex-1 sm:flex-initial">
                      <Check className="w-4 h-4 mr-2" />
                      {isRespondingToInvite ? 'Processing...' : 'Accept'}
                    </Button>
                    <Button variant="outline" onClick={handleDeclineInvitation} disabled={isRespondingToInvite} className="flex-1 sm:flex-initial">
